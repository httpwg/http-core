...
<xsl:template match="/">
  ...
  <xsl:variable name="generated"><section title="Collected ABNF" anchor="collected.abnf">
    <t>
      <xsl:choose>
        <xsl:when test="not(starts-with(/rfc/@docName,'draft-ietf-httpbis-semantics'))">In the collected ABNF below, list rules are expanded per <xref target='HTTP' x:rel='#abnf.extension'/>.</xsl:when>
